        ...
        >
          <div style={{ width: "70%" }}>
            ...
            <p className="text-center mb-4">
              Embark on a visual journey – your moments, your gallery, your
              story. Register Today!
            </p>
            {showAlert && (
              ...
              <div className="card-body">
                ...
                >
                  <div className="mb-4 d-flex align-items-center">
                    <img src={user_icon} alt="Name :" className="me-3" />
                    <input
                      type="text"
                      id="name"
                      name="name"
                ...
                <p className="mt-1" style={{ marginLeft: "120px" }}>
                  Already a member?{" "}
                  <a
                    style={{
                      color: "blue",
