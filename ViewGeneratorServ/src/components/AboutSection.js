    ...
    return (
      <div className="about-section">
        <div className="about-content">
          <h2>Our Story</h2>
          <p>
            Welcome to <b>ImageGallery</b>, a cloud-centric photo gallery where
          ...
          <p>
            At ImageGallery, we've embraced modern software design principles to
